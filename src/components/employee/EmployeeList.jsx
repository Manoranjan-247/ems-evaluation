...
const EmployeeList = () => {
  ...
  const filteredEmployees = employees.filter((emp) =>
    emp.fullName.toLowerCase().includes(debouncedQuery.toLowerCase()) ||
    emp.phoneNumber.toLowerCase().includes(debouncedQuery.toLowerCase()) ||
    emp.empId.toLowerCase().includes(debouncedQuery.toLowerCase()) ||
    emp.designation.toLowerCase().includes(debouncedQuery.toLowerCase()) ||
  ...
  const handleEdit = async (empId) => {
    sessionStorage.setItem("EmployeeListPage", page);
